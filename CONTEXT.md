...
| Topic buckets | The 6 controlled-vocabulary values currently valid for `topics`: Gaming, Tech, AI / Agents, Public Speaking / Presentations, Career / Students, Journalism / Marketing / PR. Two slots (7/8) reserved for future buckets, not populated yet. | A post may carry multiple buckets. Assigned via plan 0002's deterministic tags/categories → topics mapping script. |
