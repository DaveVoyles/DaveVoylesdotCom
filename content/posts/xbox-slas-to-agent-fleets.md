...
This is **part 4** of the [Agent production system](/posts/agent-production-system/) series. Previous: [Docker homelab ops](/posts/docker-homelab-agent-ops/).
...
Platform TPM work is not “meetings about meetings.” At its best it is **critical path, risk, multi-team alignment, and SLA performance** under real blast radius. Agent fleets inherit that muscle. They do not replace it.
...
If you only copy the **tools** of agents and not the **governance** of platform delivery, you get novelty without reliability.

## Builder-first is the point

I still build: homelab, agents, sports tech, coaching tools. TPM craft without builder hands goes abstract. Builder hands without program craft go fragile.
